...
function Sendbox({sendMessage, text, setText, sendMessageButton, deletePopupState}) {
      ...
      return (
        <div className="discussion-sendbox">
              ...
              <button className="discussion-delete-button" onClick={e => deletePopupState()}><FontAwesomeIcon icon = 'trash-alt' size = "2x"/></button>
        </div>
      );
    }
